...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "전국 500개 단지·MAU 10만 규모의 아파트 커뮤니티 플랫폼. 5종 예약·결제·이용권이 한 코드베이스에 얽힌 환경에서 기능 개발과 아키텍처 개선을 병행 수행",
    tags: [
      "React",
      "TypeScript",
      "React Query",
    ...
    company: "에이치티비욘드",
    highlights: [
      "시간·공간·강좌·숙박·레슨 등 5종 예약 도메인과 PG·관리비 결제, 이용권 관리가 한 코드베이스에 얽힌 환경에서 기능 개발과 아키텍처 개선 병행",
